          ...
          <div className="relative">
            ...
            <Carousel setApi={setApi} opts={{ loop: true }} className="w-full">
              <CarouselContent>
                ...
                <CarouselItem className="basis-[280px] md:basis-[240px]" key={index}>
                    <div className="bg-primary-foreground/10 rounded-lg p-5 flex flex-col gap-2 border border-primary-foreground/20">
                      <h3 className="text-base tracking-tight font-serif font-semibold text-primary-foreground">
                        {testimonial.quote}
                      </h3>
                      <p className="text-primary-foreground/70 text-sm leading-relaxed max-w-[180px]">
